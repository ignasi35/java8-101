...
create table "COMPANIES" ("ID" INTEGER NOT NULL, "NAME" VARCHAR NOT NULL, "LOCATION_ID" INTEGER NOT NULL);
create table "LOCATIONS" ("ID" INTEGER NOT NULL, "NAME" VARCHAR NOT NULL);


insert into "LOCATIONS" values (1, 'California');
insert into "LOCATIONS" values (2, 'Massachusetts');
insert into "LOCATIONS" values (3, 'New York');
insert into "LOCATIONS" values (4, 'Connecticut');
insert into "LOCATIONS" values (5, 'Texas');
insert into "LOCATIONS" values (6, 'Canada');
insert into "LOCATIONS" values (7, 'Pennsylvania');
insert into "LOCATIONS" values (8, 'New Mexico');
insert into "LOCATIONS" values (9, 'Japan');
insert into "LOCATIONS" values (10, 'Finland');
insert into "LOCATIONS" values (11, 'United Kingdom');
insert into "LOCATIONS" values (12, 'South Korea');
insert into "LOCATIONS" values (13, 'Washington');
insert into "LOCATIONS" values (14, 'Utah');
insert into "LOCATIONS" values (15, 'New Jersey');
insert into "LOCATIONS" values (16, 'China');
insert into "LOCATIONS" values (17, 'Taiwan');


insert into "COMPANIES" values (1,'Apple Inc.', 1);
insert into "COMPANIES" values (2,'Thinking Machines', 2);
insert into "COMPANIES" values (3,'RCA', 3);
insert into "COMPANIES" values (4,'Netronics', 4);
insert into "COMPANIES" values (5,'Tandy Corporation', 5);
insert into "COMPANIES" values (6,'Commodore International', 6);
insert into "COMPANIES" values (7,'MOS Technology', 7);
insert into "COMPANIES" values (8,'Micro Instrumentation and Telemetry Systems', 8);
insert into "COMPANIES" values (9,'IMS Associates,  Inc.', 1);
insert into "COMPANIES" values (10,'Digital Equipment Corporation', 2);
insert into "COMPANIES" values (11,'Lincoln Laboratory', 2);
insert into "COMPANIES" values (12,'Moore School of Electrical Engineering', 7);
insert into "COMPANIES" values (13,'IBM', 3);
insert into "COMPANIES" values (14,'Amiga Corporation', 1);
insert into "COMPANIES" values (15,'Canon', 9);
insert into "COMPANIES" values (16,'Nokia', 10);
insert into "COMPANIES" values (17,'Sony', 9);
insert into "COMPANIES" values (18,'OQO', 1);
insert into "COMPANIES" values (19,'NeXT', 1);
insert into "COMPANIES" values (20,'Atari', 1);
insert into "COMPANIES" values (22,'Acorn ComputersRow', 11);
insert into "COMPANIES" values (23,'Timex Sinclair', 11);
insert into "COMPANIES" values (24,'Nintendo', 9);
insert into "COMPANIES" values (25,'Sinclair Research Ltd', 11);
insert into "COMPANIES" values (26,'Xerox', 3);
insert into "COMPANIES" values (27,'Hewlett-Packard', 1);
insert into "COMPANIES" values (28,'Zemmix', 12);
insert into "COMPANIES" values (29,'ACVS', 1);
insert into "COMPANIES" values (30,'Sanyo', 9);
insert into "COMPANIES" values (31,'Cray', 13);
insert into "COMPANIES" values (32,'Evans & Sutherland', 14);
insert into "COMPANIES" values (33,'E.S.R. Inc.', 15);
insert into "COMPANIES" values (34,'OMRON', 9);
insert into "COMPANIES" values (35,'BBN Technologies', 2);
insert into "COMPANIES" values (36,'Lenovo Group', 16);
insert into "COMPANIES" values (37,'ASUS', 17);
insert into "COMPANIES" values (38,'Amstrad', 11);
insert into "COMPANIES" values (39,'Sun Microsystems', 1);
insert into "COMPANIES" values (40,'Texas Instruments', 5);
insert into "COMPANIES" values (41,'HTC Corporation', 17);
insert into "COMPANIES" values (42,'Research In Motion', 6);
insert into "COMPANIES" values (43,'Samsung Electronics', 12);
